...
<br>Vdot = A * sqrt(2*L / (FrictionFactor * rho * d_h))*sqrt(&Delta;p)
    ...
    Functions.squareRootFunction(pressureDrop, 10);
    pressureDrop = portA.p - portB.p;
    HTIn.T=T_out;
    HTOut.cp=cp;
    HTOut.h=h;
...
<br>Vdot = &plusmn; A * sqrt(|&Delta;p|*2 / (&Delta;p * &zeta;))
  ...
  package Compressor
    ...
    //Exergy
    der(EA)=portA.m_flow*(mediumA.h-h_0-T_amb*(Medium.specificEntropy(mediumA)-s_0));
  ...
  package Mixers
    ...
    E_D=E_streamA+E_streamB+E_streamC;
      annotation (preferedView="text", Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-60,-60},
            ...
            graphics={Bitmap(extent={{-60,40},{108,-60}}, fileName="Graphics/FlowConnector.png")}));
    end IdealMixing;
  end Mixers;
  ...
  package Switches
    ...
    package WithStop
      ...
      annotation (preferedView="text", Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-60,-60},
              ...
              graphics={Bitmap(extent={{-66,62},{80,-62}}, fileName="Graphics/FlowSwitch.png")}));
      end Switch2Flows;
...
reduction valve"     annotation(Dialog(group="Refuelling tank switch pressure"));
  ...
  package PhDthesis
    ...
    package VerificationOfComponents
      ...
      inner parameter SI.Pressure P_amb=101e3;
      inner parameter SI.Temperature T_cool=-40;
        PressureLosses.TubeWithheatTransfer
      ...
      // inner Integer z4;
        ...
        HydrogenRefuelingCoolProp.Tanks.Tank1 tank1_3(
          ...
          Adiabatic=true,
          pInitial=1500000)
          annotation (Placement(transformation(extent={{66,34},{44,26}})));
        PressureLosses.PressureLoss pressureLoss1(
          redeclare package Medium = Medium,
          inputChoice="Valve",
          kv=0.4,
          pInitial=1500000)
          annotation (Placement(transformation(extent={{16,34},{32,26}})));
