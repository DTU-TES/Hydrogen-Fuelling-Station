within ;
package HydrogenFuellingLibrary
  "Hydrogen Fuelling Library has been deveolop by Erasmus Rothuizen during his PhD project: Hydrogen Fuelling Stations - A Thermodynamic Analysis of Fuelling Hydrogen Vehicles for Personal TransportationThe library may be used by anyone as long as they contribute their development of the library to the open acces library"
...
<br>Vdot = &plusmn; A * sqrt(|&Delta;p|*2 / (&Delta;p * &zeta;))
    ...
    public
      ...
      SI.Velocity w_out "Velocity";
      SI.VolumeFlowRate Vdot_out "Volume flow rate";
      SI.Density d_out "density";
      ...
      SI.KineticEnergy K_e;
        SI.KineticEnergy K_e_out;
      Real K_r;
      Real E_r;
      SI.Power EB_2;
      //Exergy
    ...
    equation
      ...
      w=Vdot/A "Velocity";
      Vdot_out=portA.m_flow/d_out "Volume flow";
      w_out=Vdot_out/A "Velocity";
    ...
    //Deciding properties denpendent on the flow direction
      ...
      mediumB=Medium.setState_ph(portB.p,portB.h_outflow);
        d_in = max(medium1.d,0.00000001);
         d_out = max(medium2.d,0.00000001);
      ...
      mediumB=Medium.setState_ph(portB.p,inStream(portB.h_outflow));
        d_in = max(medium2.d,0.00000001);
        d_out = max(medium1.d,0.00000001);
    ...
    E_r=(K_e_out-K_e)/max(EB_2,1);
    K_e_out=0.5*w_out^2;

    // Exergy
    der(EA)=abs(portA.m_flow)*(mediumA.h-h_0-T_amb*(mediumA.s-s_0));
    der(EB)=abs(portA.m_flow)*(mediumB.h-h_0-T_amb*(mediumB.s-s_0));
    EB_2=abs(portA.m_flow)*(mediumB.h-h_0-T_amb*(mediumB.s-s_0));
      annotation (
        preferedView="text",
        Documentation(info="<html>
<p>
  ...
  package PhDthesis
    ...
    package VerificationOfComponents
      model Tanks
        ...
        HydrogenFuellingLibrary.Tanks.Tank1 tank1_1(
          ...
          Adiabatic=true,
          pInitial=60000)
          annotation (Placement(transformation(extent={{-80,2},{-58,10}})));
        HydrogenFuellingLibrary.Tanks.Tank1 tank1_2(
          redeclare package Medium = Medium,
          Adiabatic=true,
          pInitial=80000)
      ...
      inner parameter SI.Temperature T_cool=-40;
        HeatExchangers.HeatExchangerFixedTemperatureOneWay
          ...
          T_hex=233.15,
          COP=1)
          annotation (Placement(transformation(extent={{-30,-2},{-10,10}})));
        Compressor.Compressor compressor(redeclare package Medium = Medium, V=
              0.0002)
          annotation (Placement(transformation(extent={{-50,4},{-36,12}})));
      ...
      u_0=h_0-P_amb*1/medium.d;
        ...
        connect(compressor.portB, heatExchangerFixedTemperature.portA)
          annotation (Line(
            points={{-38.2,6},{-28,6}},
            color={0,0,0},
            thickness=0.5,
        ...
        connect(compressor.portA, tank1_1.portA) annotation (Line(
            points={{-47.8,6},{-59.7,6}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(pressureLoss.portB, tank1_2.portA) annotation (Line(
            points={{13.4,6},{19.5455,6}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(pressureLoss.portA, heatExchangerFixedTemperature.portB)
          annotation (Line(
            points={{-1.8,6},{-12,6}},
            color={0,0,0},
            thickness=0.5,
      ...
      model HeatTransfer
        ...
        import HydrogenRefuelingCoolProp = HydrogenFuellingLibrary;
        ...
        HydrogenRefuelingCoolProp.PressureLosses.PressureLoss
          ...
          inputChoice="Valve",
          kv=0.3)
          annotation (Placement(transformation(extent={{-18,2},{-2,10}})));
      SI.InternalEnergy U;
      SI.Mass M;
      SI.Enthalpy H;

      inner parameter SI.Temperature T_amb=293;
        HydrogenRefuelingCoolProp.HeatTransfer.HeatTransferTank
          heatTransferTank(
          Charging=true,
          tank=3,
          h_charging=150)
      ...
      equation
         ...
         H=tank1_1.h*tank1_1.M+tank1_2.h*tank1_2.M;
        connect(pressureLoss.portB, tank1_2.portA) annotation (Line(
            points={{-2.4,6},{19.5455,6}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(pressureLoss.portA, tank1_1.portA) annotation (Line(
            points={{-17.8,6},{-37.7,6}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
      ...
      inner parameter SI.Temperature T_amb=293;
        HydrogenRefuelingCoolProp.PressureLosses.TubeWithheatTransfer
          tubeWithheatTransfer(
          redeclare package Medium = Medium,
          Length=12,
          pInitial=2000000)
          annotation (Placement(transformation(extent={{-42,-4},{-22,16}})));
        HydrogenRefuelingCoolProp.HeatTransfer.HeatTransferTube heatTransferTube(Length=12)
      ...
      equation
        ...
        connect(pressureLoss.portB, tank1_2.portA) annotation (Line(
            ...
            thickness=0.5,
            smooth=Smooth.None));
        connect(tubeWithheatTransfer.portB, pressureLoss.portA) annotation (Line(
            points={{-24,6},{-17.8,6}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(tubeWithheatTransfer.portA, tank1_1.portA) annotation (Line(
            points={{-40,6},{-45.7,6}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(heatTransferTube.HT2, tubeWithheatTransfer.HTIn) annotation (
            Line(
            points={{-25.6,-12},{-24.4,-12},{-24.4,2.8}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(heatTransferTube.HTIn, tubeWithheatTransfer.HTOut) annotation (
            Line(
            points={{-38.6,-12},{-38.6,-6},{-39.8,-6},{-39.8,2.8}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
      ...
      model Mixers
       ...
       replaceable package Medium = CoolProp2Modelica.Media.Hydrogen (onePhase=true)
         constrainedby Modelica.Media.Interfaces.PartialMedium
                                                     annotation (choicesAllMatching=true);
        TIL_Hydrogen_CoolProp.HRSInfo HRSinfo
          annotation (Placement(transformation(extent={{80,80},{100,100}})));
      ...
      //parameter Boolean control_valve=true;
      ...
      // inner Integer z4;
        ...
        HydrogenRefuelingCoolProp.Tanks.Tank1 tank1_1(
          ...
          Adiabatic=true,
          pInitial=2000000)
          annotation (Placement(transformation(extent={{-74,16},{-52,24}})));
        ...
        PressureLosses.PressureLoss pressureLoss(
          ...
          inputChoice="Valve",
          kv=0.5)
          annotation (Placement(transformation(extent={{14,16},{30,24}})));
        HydrogenRefuelingCoolProp.Mixers.VolumeMixer Mixer(
          redeclare package Medium = Medium,
          fixedInitialPressure=false,
          pInitial=1600000)
          annotation (Placement(transformation(extent={{-20,12},{-2,26}})));
        HydrogenRefuelingCoolProp.Tanks.Tank1 tank1_3(
          redeclare package Medium = Medium,
          Adiabatic=true,
          pInitial=1500000)
          annotation (Placement(transformation(extent={{64,-2},{42,6}})));
        PressureLosses.PressureLoss pressureLoss1(
          redeclare package Medium = Medium,
          inputChoice="Valve",
          kv=0.4,
          pInitial=1500000)
          annotation (Placement(transformation(extent={{14,-2},{30,6}})));
      ...
      //Real EnergyBalance;
        PressureLosses.PressureLoss pressureLoss2(
          ...
          kv=1,
          pInitial=1500000)
          annotation (Placement(transformation(extent={{-44,16},{-28,24}})));
      equation
          medium=Medium.setState_pT(P_amb, T_amb);
      s_0=medium.s;
      h_0=medium.h;
      ...
      //noEvent(junction.portA.m_flow+junction.portA.m_flow+junction.portA.m_flow+junction.drhodt*junction.V)=MassBalance;
      //tank1_1.M+tank1_2.M+tank1_3.M+Mixer.M=MassBalance;
      //tank1_1.U+tank1_2.U+tank1_3.U+Mixer.U=EnergyBalance;
      ...
      HRSinfo.P_ref=P_ref;
        ...
        connect(pressureLoss.portB, tank1_2.portA) annotation (Line(
            points={{29.4,20},{43.7,20}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(Mixer.portB, pressureLoss.portA)    annotation (Line(
            points={{-3.4,20},{14.2,20}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(pressureLoss1.portA, Mixer.portC)    annotation (Line(
            points={{14.2,2},{6,2},{6,14},{-3.4,14}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(tank1_3.portA, pressureLoss1.portB) annotation (Line(
            points={{43.7,2},{29.4,2}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(pressureLoss2.portB, Mixer.portA) annotation (Line(
            points={{-28.6,20},{-18.8,20}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(pressureLoss2.portA, tank1_1.portA) annotation (Line(
            points={{-43.8,20},{-53.7,20}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
      ...
      // inner Integer z4;
        ...
        HydrogenRefuelingCoolProp.Tanks.Tank1 tank1_4(
          ...
          V=1,
          pInitial=100000)
          annotation (Placement(transformation(extent={{66,4},{44,12}})));
        PressureLosses.PressureLoss pressureLoss1(
          redeclare package Medium = Medium,
          kp=0.1,
          Diameter=0.01,
          ...
          kv=0.6,
          pInitial=4000000)
                  annotation (Placement(transformation(extent={{-24,4},{-8,12}})));
        PressureLosses.AveragePressureRampRate averagePressureRampRate(
          SAEJ2601=false,
          redeclare package Medium = Medium,
          APRR2=2000000,
          pInitial=100000)
          annotation (Placement(transformation(extent={{24,4},{36,14}})));
        PressureLosses.ReductionValve reductionValve(redeclare package Medium
            = Medium,
          pInitialIn=4000000,
          pInitialOut=100000)
          annotation (Placement(transformation(extent={{2,4},{14,12}})));
      equation
      //   control.z1=z1;
      //   control.z2=z2;
      //   control.z3=z3;
      ...
      HRSinfo.P_ref=P_ref;
        ...
        connect(averagePressureRampRate.portB,tank1_4. portA) annotation (Line(
            points={{35.2,8},{45.7,8}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(reductionValve.portB, averagePressureRampRate.portA) annotation (
            Line(
            points={{14,8},{25,8}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(pressureLoss1.portB, reductionValve.portA) annotation (Line(
            points={{-8.4,8},{2,8}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(pressureLoss1.portA, tank1_3.portA) annotation (Line(
            points={{-23.8,8},{-33.7,8}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
      ...
      equation
        ...
        EnergyBalance=compressor.portA.m_flow*compressor.mediumA.h+der(compressor.W);
      //   control.z1=z1;
      //   control.z2=z2;
      //   control.z3=z3;
      //   control.z4=z4;
      ...
      HRSinfo.P_ref=P_ref;
        ...
        connect(compressor.portA, tank1_1.portA) annotation (Line(
            points={{14.2,20},{-7.7,20}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(compressor.portB, tank1_2.portA) annotation (Line(
            points={{23.8,20},{43.7,20}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        annotation (Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,
      ...
      //compressor.mediumB.h*compressor.portA.m_flow+
      //Real EnergyBalance;
        HeatExchangers.HeatExchangerFixedTemperature heatExchangerFixedTemperature(
          redeclare package Medium = Medium,
          SAEJ2601=true,
          T_hex=273.15)
          annotation (Placement(transformation(extent={{8,12},{28,24}})));
        PressureLosses.PressureLoss pressureLoss(
          redeclare package Medium = Medium,
          inputChoice="Valve",
          kv=0.3) annotation (Placement(transformation(extent={{-16,16},{0,24}})));
      equation
      ...
      HRSinfo.P_ref=P_ref;
        ...
        connect(heatExchangerFixedTemperature.portB, tank1_2.portA) annotation (Line(
            points={{26,20},{43.7,20}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(pressureLoss.portB, heatExchangerFixedTemperature.portA) annotation (
            Line(
            points={{-0.4,20},{10,20}},
            color={0,0,0},
            thickness=0.5,
    ...
    package paper3
      ...
      HRSinfo.P_ref=P_ref;
        ...
        connect(control.pp9, HSS.pp) annotation (Line(
            points={{6,82.2},{18,82.2},{18,76},{142.909,76},{142.909,-44.2}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        connect(control.pp10, HSS.pp) annotation (Line(
            points={{6,86.1},{18,86.1},{18,76},{142.909,76},{142.909,-44.2}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
        ...
        connect(control.pp12, HSS.pp) annotation (Line(
            points={{6,92.1},{18,92.1},{18,76},{142.909,76},{142.909,-44.2}},
            color={0,0,0},
            thickness=0.5,
            smooth=Smooth.None));
